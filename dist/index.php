...
<g>
	<path d="M37.7,92.2C23,92.2,11,80.3,11,65.5c0-11.6,7.6-21.9,18.5-25.4v-12c-2.1-0.2-3.7-2-3.7-4.1c0-2.3,1.9-4.1,4.1-4.1h15.3
		c2.3,0,4.1,1.9,4.1,4.1c0,2.2-1.6,3.9-3.7,4.1v12c11,3.5,18.5,13.8,18.5,25.4C64.4,80.3,52.4,92.2,37.7,92.2z M30,22.7
...
<g>
	<path d="M58.9,63.8c0,0-9.8,4-17.1,0.1C41.8,63.9,50.6,58.7,58.9,63.8z"/>
</g>
<g>
	<path d="M43.7,28.1h-3.4c-0.8,0-1.4-0.6-1.4-1.4s0.6-1.4,1.4-1.4h3.4c0.8,0,1.4,0.6,1.4,1.4S44.5,28.1,43.7,28.1z"/>
</g>
<path id="flask--potion" d="M59.4,65.4c-15.2,6.3-20.5-3.6-33.4-3.6c-10,0-10,3.6-10,3.6c0,12,9.7,21.7,21.7,21.7C57.2,87.1,60,65.1,59.4,65.4z
	 M21.1,67.4c0-1.1,0.9-1.9,1.9-1.9s1.9,0.9,1.9,1.9c0,1.1-0.9,1.9-1.9,1.9S21.1,68.5,21.1,67.4z M25,78.8c-0.6,0-1.1-0.5-1.1-1.1
	s0.5-1.1,1.1-1.1s1.1,0.5,1.1,1.1S25.6,78.8,25,78.8z M33.2,76.1c-2.3,0-4.1-1.8-4.1-4.1s1.8-4.1,4.1-4.1s4.1,1.8,4.1,4.1
	S35.5,76.1,33.2,76.1z M45.8,80.2c-1,0-1.8-0.8-1.8-1.8c0-1,0.8-1.8,1.8-1.8c1,0,1.8,0.8,1.8,1.8C47.6,79.5,46.8,80.2,45.8,80.2z
	 M50.6,73.3c-0.4,0-0.8-0.3-0.8-0.8s0.3-0.8,0.8-0.8c0.4,0,0.8,0.4,0.8,0.8C51.4,73,51,73.3,50.6,73.3z"/>
</svg>
      </span>
    </div>
  </div>
    ...
    <div class="screen-bgs">
      ...
      <div class="screen--video video-frnkrok">
        <video autoplay loop class="fullscreen">
            <source src="//frnkrok.com/frnkrok-hq.mp4" type="video/mp4"  />
        </video>
      </div>
